                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title title-form">Modificando dados do Estoque</h3>
                        </div>
                        <div class="card-body">
                            <form id="form-adicionar" action="/estoques/store" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <input required required step="1" type="number" name="price" id="price" class="form-control" value="{{ $storage->quantity }}">
                                    </div>
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="date" class="required">Data </label>
                                        <input required type="date" name="date" id="date" class="form-control" value="{{ $storage->date }}">
                                    </div>
                                </div>
