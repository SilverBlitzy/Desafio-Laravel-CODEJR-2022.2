                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <a href="{{ route('storages.show', $storage->id) }}" class="btn btn-secondary">
                                        <i class="far fa-eye"></i>
                                    </a>

                                    <a href="{{ route('storages.edit', $storage->id) }}" class="btn btn-info">
                                        <i class="far fa-edit"></i>
                                    </a>

                                    <form class="form-delete d-inline-block" action="{{ route('storages.destroy', $storage->id) }}" method="post">
                                        @csrf
                                        @method('delete')
